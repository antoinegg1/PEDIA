...
from pedia.models.sam3.model.decoder import (
    TransformerDecoder,
    TransformerDecoderLayer,
)
from pedia.models.sam3.model.encoder import TransformerEncoderFusion, TransformerEncoderLayer
from pedia.models.sam3.model.geometry_encoders import SequenceGeometryEncoder
from pedia.models.sam3.model.maskformer_segmentation import PixelDecoder, UniversalSegmentationHead
from pedia.models.sam3.model.memory import (
    CXBlock,
)
from pedia.models.sam3.model.model_misc import (
    DotProductScoring,
    MLP,
    MultiheadAttentionWrapper as MultiheadAttention,
    TransformerWrapper,
)
from pedia.models.sam3.model.necks import Sam3DualViTDetNeck
from pedia.models.sam3.model.position_encoding import PositionEmbeddingSine
from pedia.models.sam3.model.sam3_image import Sam3Image
from pedia.models.sam3.model.text_encoder_ve import VETextEncoder
from pedia.models.sam3.model.tokenizer_ve import SimpleTokenizer
from pedia.models.sam3.model.vitdet import ViT
from pedia.models.sam3.model.vl_combiner import SAM3VLBackbone
...
def _create_sam3_model(
    ...
    if not eval_mode:
        raise NotImplementedError(
            ...
            "The vendored pedia.models.sam3 only supports eval_mode=True."
        )
...
def _setup_device_and_mode(model, device, eval_mode):
    """Setup model device, dtype, and evaluation mode."""
    # Explicitly convert all parameters and buffers to float32 to avoid
    # dtype mismatches with Sam3Processor inputs (which are float32).
    # Checkpoint weights may be stored as bfloat16.
...
def build_sam3_image_model(
    ...
    if enable_inst_interactivity:
        raise NotImplementedError(
            ...
            "The vendored pedia.models.sam3 only supports "
            "enable_inst_interactivity=False."
        )
    inst_predictor = None
...
def build_sam3_multiplex_video_model(
    ...
    from pedia.models.sam3.model.video_tracking_multiplex_demo import Sam3VideoTrackingMultiplexDemo
...
def build_sam3_multiplex_video_predictor(
    ...
    from pedia.models.sam3.model.sam3_multiplex_base import Sam3MultiplexPredictorWrapper
    from pedia.models.sam3.model.sam3_multiplex_detector import Sam3MultiplexDetector
    from pedia.models.sam3.model.sam3_multiplex_tracking import (
        Sam3MultiplexTrackingWithInteractivity,
    )
    from pedia.models.sam3.model.sam3_multiplex_video_predictor import Sam3MultiplexVideoPredictor
