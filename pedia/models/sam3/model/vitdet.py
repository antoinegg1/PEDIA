...
from pedia.models.sam3.model.data_misc import NestedTensor
from pedia.models.sam3.model.model_misc import AttentionType, LayerScale
from pedia.models.sam3.perflib.fused import addmm_act
from pedia.models.sam3.sam.rope import apply_rotary_enc_real, VisionRotaryEmbeddingVE
...
class Attention(nn.Module):
    ...
    def forward(self, x: Tensor) -> Tensor:
        ...
        if self.attn_type == AttentionType.Vanilla:
            if self.use_fa3:
                from pedia.models.sam3.perflib.fa3 import flash_attn_func
