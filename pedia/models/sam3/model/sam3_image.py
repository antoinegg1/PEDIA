...
import numpy as np
import torch
from pedia.models.sam3.model.model_misc import SAM3Output
from pedia.models.sam3.model.vl_combiner import SAM3VLBackbone
from pedia.models.sam3.perflib.nms import nms_masks

try:
    from pedia.models.sam3.model.sam1_task_predictor import SAM3InteractiveImagePredictor
except ImportError:
    SAM3InteractiveImagePredictor = None

try:
    from pedia.models.sam3.train.data.collator import BatchedDatapoint
except ImportError:
