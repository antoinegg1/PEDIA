...
Used by both the inference driver (`pedia.scripts.async_generate_with_tool_call_api`)
and the eval driver (`pedia.evaluation.eval_unified`) so that callers only need to
