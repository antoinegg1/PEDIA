...
from pedia.prompts import EVAL_QUERY_PROMPT, EVAL_SYSTEM_PROMPT
from pedia.utils.io_utils import iter_meta_info_files, load_records
from pedia.utils.stats import compute_tool_combination_statistics, get_input_tokens_total, get_output_tokens_total, get_total_tokens
from pedia.utils.text_utils import extract_response_text, get_final_prediction, parse_score
...
def main(
    *,
    ...
    if not additional_prompt and args.dataset_name:
        from pedia.datasets.task_registry import get_dataset_spec
