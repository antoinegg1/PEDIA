...
from pedia.prompts import get_tool_agent_prompt
from pedia.tool_definitions.agents import get_actor_class
...
class ToolAgentManager:
    ...
    def connect_to_existing_agents(
        ...
        if configs is None:
            from pedia.tool_definitions.agents import AGENT_CONFIGS
