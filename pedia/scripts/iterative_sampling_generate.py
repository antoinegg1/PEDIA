...
from pedia.prompts.system_prompts import (
...
from pedia.tool_definitions import ToolRouter
from pedia.evaluation.trajectory_judge import TrajectoryJudge
from pedia.utils.logger import setup_logger
from pedia.utils.stats import save_global_meta_info
from pedia.utils.text_utils import extract_response_text
from pedia.utils.worker_utils import init_worker_base, WorkerContext
...
def _validate_trajectory(
    ...
    if task_category == "maze" and image_path and check_correctness:
        from pedia.evaluation.maze_verifier import maze_judge
    ...
    if task_category == "reason_map" and check_correctness:
        from pedia.evaluation.reason_map_verifier import reason_map_judge
    ...
    if task_category == "map_trace" and check_correctness:
        from pedia.evaluation.map_trace_verifier import map_trace_judge
