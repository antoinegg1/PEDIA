...
# pedia.evaluation.eval_datasets.DATASET_REGISTRY.
#
# Examples:
#   bash pedia/scripts/run_inference.sh                       # visual_probe_easy
#   DATASET=reason_map bash pedia/scripts/run_inference.sh    # any registered id
#   VLLM_PORT=8001 bash pedia/scripts/run_inference.sh        # tweak vLLM
set -euo pipefail
...
# ─── 4. Run inference ───
python -m pedia.scripts.async_generate_with_tool_call_api \
    --dataset "$DATASET" \
