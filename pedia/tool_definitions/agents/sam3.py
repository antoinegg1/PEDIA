...
from pedia.environment.tool_agents.actor import BaseToolModelActor
...
class SAM3Actor(BaseToolModelActor):
    ...
    def __init__(self, model_name: str):
        ...
        from pedia.models.sam3 import build_sam3_image_model
        from pedia.models.sam3.model.sam3_image_processor import Sam3Processor
