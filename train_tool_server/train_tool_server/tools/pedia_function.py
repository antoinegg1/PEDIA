...
from .pedia_base import PediaToolBase, _AREAL_ROOT
...
def _load_function_tools():
    ...
    tools_dir = os.path.join(_AREAL_ROOT, "pedia", "tool_definitions", "functions")
    modules = {
        "image_crop": "crop.py",
...
@register_tool
class PediaFunctionTool(PediaToolBase):
    ...
    def __init__(self, num_workers=1):
        ...
        logger.info(
            f"PediaFunctionTool loaded {len(self.function_tools)} tools: "
