"""
Shared base class for pedia tool types.
...
# Ensure pedia package is importable
...
# ---------------------------------------------------------------------------
# Base tool class for all pedia tools
# ---------------------------------------------------------------------------

class PediaToolBase(BaseTool):
    """Base class for pedia tool types (both function and agent)."""
...
class PediaAgentToolBase(PediaToolBase):
    """Base class for agent-based pedia tools that require GPU + Ray."""
    ...
    def _load_agent_tools(self):
        ...
        try:
            ...
            from pedia.tool_definitions.router import ToolRouter
